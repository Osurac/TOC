...
HD_PWD='C:/Users/Osurac/Practica2/Practica2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cerrojo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cerrojo.tcl
