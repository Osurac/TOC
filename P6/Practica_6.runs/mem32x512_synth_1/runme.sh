...
HD_PWD='C:/Users/Osurac/Downloads/MIPSMulticiclo_R3yModoDepuracion/MIPSMulticiclo_R3yModoDepuracion/MIPSMulticiclo_R3yModoDepuracion.runs/mem32x512_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mem32x512.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mem32x512.tcl
